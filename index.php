  ...
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="note">Values adapted to Loadplus branding from industry standards.</div>
      </div>

      <div class="modal-footer">
        <a class="btn btn-site" href="https://www.ashtechindia.net/fly-ash/" target="_blank" rel="noopener">Source page</a>
