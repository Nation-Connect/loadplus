...
<!-- Fly Ash — Modal -->
<div class="modal fade" id="modalFlyAsh" tabindex="-1" aria-labelledby="modalFlyAshLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
    <div class="modal-content rounded-14">
      <div class="modal-header">
        <h5 class="modal-title" id="modalFlyAshLabel">Fly Ash — Details</h5>
      ...
      <div class="modal-body">
        <!-- What is Fly Ash -->
        <section class="mb-3">
          <h6 class="fw-bold">What is Fly Ash</h6>
          <p>
            Fly Ash (pulverized fuel ash) is a byproduct of a coal-based thermal power station generated by the 
            combustion of pulverized coal. It is a fine, grey amorphous powder, rich in silica & alumina and 
            spherical in shape. Its properties vary based on the coal type, combustion process, and plant efficiency, 
            all of which affect its utilization quality.
          </p>
        </section>

        <!-- Technology & Quality -->
        <section class="mb-3">
          <h6 class="fw-bold">Leveraging Technology to Elevate Quality</h6>
          <p>
          ...
          <p>
            Our Fly Ash meets stringent international standards: IS EN 450 S, ASTM C 618 Class F, and IS 3812 Grade I.
          </p>
        </section>

        <!-- Concrete Advantages -->
        <section class="mb-3">
          <h6 class="fw-bold">Concrete Application Advantages</h6>
          <ul>
            <li>Better Workability</li>
            <li>Reduces Permeability</li>
            <li>Reduces Heat of Hydration</li>
            <li>Improves Pumpability</li>
            <li>Improves Sulphate & Chloride Resistance</li>
            <li>Reduces Risk of Alkali Aggregate Reaction</li>
            <li>Increases Long Term Strength</li>
            <li>Better Concrete Finish</li>
            <li>Reduces Bleeding & Segregation</li>
            <li>Reduces Shrinkage</li>
          </ul>
        </section>

        <!-- Masonry Advantages -->
        <section class="mb-3">
          <h6 class="fw-bold">Masonry Application Advantages</h6>
          <ul>
            <li>Better Mortar Workability</li>
            <li>Reduces Cracks</li>
            <li>Improves Water Retention</li>
            <li>Increases Masonry Strength</li>
          </ul>
        </section>

        <!-- Applications -->
        <section class="mb-3">
          <h6 class="fw-bold">Applications of Fly Ash</h6>
          <ul>
            <li>Ready Mix Concrete</li>
            <li>Asbestos Products Manufacturing</li>
            <li>Cement Manufacturing</li>
            <li>Bricks & Blocks Manufacturing</li>
            <li>Builders & Contractors</li>
            <li>Precast Manufacturing</li>
            <li>Plaster & Masonry Works</li>
            <li>Land Fill & many more</li>
          </ul>
        </section>
            ...
            <table class="table table-sm table-bordered">
              <thead class="table-light">
                <tr>
                  ...
                  <th>Loadplus SUPERPOZZ™</th>
                  <th>Loadplus DURACRETE™</th>
                </tr>
              </thead>
              <tbody>
                <tr><td>SiO₂ + Al₂O₃ + Fe₂O₃ (%) Min</td><td>70.00</td><td>70.00</td><td>70.00</td><td>95.89</td><td>92.83</td></tr>
                <tr><td>SiO₂ (%) by mass Min</td><td>-</td><td>-</td><td>35.00</td><td>62.57</td><td>60.80</td></tr>
                <tr><td>MgO (%) Max</td><td>4.0</td><td>5.00</td><td>5.00</td><td>0.85</td><td>0.98</td></tr>
                <tr><td>SO₃ (%) Max</td><td>2.50</td><td>5.0</td><td>2.75</td><td>0.080</td><td>0.25</td></tr>
                <tr><td>Moisture (%) Max</td><td>0.5</td><td>3.0</td><td>-</td><td>0.22</td><td>0.20</td></tr>
                <tr><td>Loss on Ignition (%) Max</td><td>7.0</td><td>6.0</td><td>6.0</td><td>&lt;1.00</td><td>&lt;1.50</td></tr>
                <tr><td>Available Alkalies as Na₂O (%) Max</td><td>-</td><td>1.50</td><td>1.50</td><td>0.96</td><td>0.98</td></tr>
                <tr><td>Fineness (% retained on 45μ) Max</td><td>12</td><td>34</td><td>34</td><td>&lt;10</td><td>&lt;30</td></tr>
              </tbody>
            </table>
          </div>
        </section>
