  ...
  <div class="container">
    ...
    <div class="row g-4">
      ...
      <div class="col-md-6 col-lg-3">
        <div class="card h-100 shadow-sm border-0 rounded-14">
          <img src="images/flyash.jpg" class="card-img-top" alt="Fly Ash">
      ...
      <div class="col-md-6 col-lg-3">
        <div class="card h-100 shadow-sm border-0 rounded-14">
          <img src="images/ultra-fine-flyash.jpg" class="card-img-top" alt="Ultra Fine Fly Ash">
          <div class="card-body text-center">
      ...
      <div class="col-md-6 col-lg-3">
        <div class="card h-100 shadow-sm border-0 rounded-14">
          <img src="images/flyash-bricks.jpg" class="card-img-top" alt="Fly Ash Bricks">
          <div class="card-body text-center">
      ...
      <div class="col-md-6 col-lg-3">
        <div class="card h-100 shadow-sm border-0 rounded-14">
          <img src="images/cenosphere.jpg" class="card-img-top" alt="Cenosphere">
          <div class="card-body text-center">
            <h5 class="card-title fw-bold" style="color:var(--c-deepteal);">Cenosphere</h5>
            <p class="card-text text-muted">
              Ultra-light, inert, hollow ceramic microspheres from fly ash. Used to reduce weight and thermal
              conductivity in cement, polymers, coatings, and composites—without sacrificing strength.
            </p>
            <ul class="text-muted small text-start list-unstyled mb-0">
              <li>• Low density (typically ~0.4–0.8 g/cm³) for light-weighting</li>
              <li>• Mostly silica & alumina; hard, water-resistant, and insulative</li>
              <li>• Improves flow, reduces shrinkage, and lowers resin usage</li>
            </ul>
          </div>
        </div>
      </div>
