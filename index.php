...
<section id="services" class="py-5 services">
  <div class="container">
    ...
    <ul class="nav nav-pills justify-content-center mb-4" id="servicesTab" role="tablist">
      ...
      <li class="nav-item" role="presentation">
        <button class="nav-link" id="tab-supplychain" data-bs-toggle="pill" data-bs-target="#pane-flyash" type="button" role="tab" aria-controls="pane-supplychain" aria-selected="false">
          FlyAsh
        </button>
      </li>
      <li class="nav-item" role="presentation">
        <button class="nav-link" id="tab-cenospheres" data-bs-toggle="pill" data-bs-target="#pane-cenospheres" type="button" role="tab" aria-controls="pane-cenospheres" aria-selected="false">
          Cenospheres
        </button>
      </li>
      <li class="nav-item" role="presentation">
        <button class="nav-link" id="tab-globaltrade" data-bs-toggle="pill" data-bs-target="#pane-globaltrade" type="button" role="tab" aria-controls="pane-globaltrade" aria-selected="false">
          ...
          <div class="row g-0 align-items-center">
            <div class="col-lg-6">
              <div class="service-media">
                <img src="images/service/integrated-logistics.1.11.jpg" alt="Warehousing">
              </div>
            </div>
            <div class="col-lg-6">
              <div class="service-body">
                ...
                <ul class="service-bullets">
                  <li><i class="bi bi-box-seam"></i><span>Inventory control, pick-pack, kitting & VAS</span></li>
                  <li><i class="bi bi-shield-check"></i><span>Audit-ready processes and compliance</span></li>
                  <li><i class="bi bi-graph-up"></i><span>Real-time dashboards & SLA tracking</span></li>
                </ul>
              </div>
            </div>
          </div>
    ...
    <!-- Fly Ash -->
        <div class="tab-pane fade" id="pane-flyash" role="tabpanel" aria-labelledby="tab-flyash" tabindex="0">
            <div class="service-card">
                <div class="row g-0 align-items-center">
                <div class="col-lg-6">
                    <div class="service-media">
                    <img src="images/service/dry-fly-ash-powder-1724740112-7578624.jpeg" alt="Fly Ash">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="service-body">
                    <h4 class="service-title">Fly Ash</h4>
                    <p class="service-lead">
                        A fine, powdery by-product from coal combustion in power plants, Fly Ash is a valuable supplementary cementitious material widely used in construction for enhanced strength, durability, and sustainability.
                    </p>
                    <ul class="service-bullets">
                        <li><i class="bi bi-bricks"></i><span>Improves concrete workability & strength</span></li>
                        <li><i class="bi bi-recycle"></i><span>Eco-friendly & sustainable building material</span></li>
                        <li><i class="bi bi-droplet-half"></i><span>Reduces water demand in concrete mix</span></li>
                        <li><i class="bi bi-building"></i><span>Used in cement, bricks, blocks & embankments</span></li>
                        <li><i class="bi bi-shield-check"></i><span>Enhances resistance to sulphate & chloride attack</span></li>
                    </ul>
                    </div>
                </div>
                </div>
       ...
       <!-- Cenospheres -->
        <div class="tab-pane fade" id="pane-cenospheres" role="tabpanel" aria-labelledby="tab-cenospheres" tabindex="0">
        <div class="service-card">
            <div class="row g-0 align-items-center">
            <div class="col-lg-6">
                <div class="service-media">
                <img src="images/service/ceno-new4.jpg" alt="Cenospheres">
                </div>
            </div>
            <div class="col-lg-6">
                <div class="service-body">
                <h4 class="service-title">Cenospheres</h4>
                <p class="service-lead">
                    Cenospheres are lightweight, inert, and hollow spheres composed mainly of silica and alumina, produced as a by-product of coal combustion in thermal power plants. Known for their low density and high strength, they are widely used across industries for advanced material applications.
                </p>
                <ul class="service-bullets">
                    <li><i class="bi bi-wind"></i><span>Ultra-lightweight filler with excellent strength-to-weight ratio</span></li>
                    <li><i class="bi bi-droplet"></i><span>Waterproof and chemically inert properties</span></li>
                    <li><i class="bi bi-recycle"></i><span>Eco-friendly and sustainable industrial material</span></li>
                    <li><i class="bi bi-palette"></i><span>Used in paints, coatings, plastics, and composites</span></li>
                    <li><i class="bi bi-hammer"></i><span>Enhances thermal insulation and wear resistance</span></li>
                    <li><i class="bi bi-tools"></i><span>Ideal for oil & gas, aerospace, construction, and automotive sectors</span></li>
                </ul>
                </div>
            </div>
            </div>
      ...
      <!-- Global Trade Solutions -->
      <div class="tab-pane fade" id="pane-globaltrade" role="tabpanel" aria-labelledby="tab-globaltrade" tabindex="0">
        <div class="service-card">
          <div class="row g-0 align-items-center">
            <div class="col-lg-6">
              <div class="service-media">
            ...
            <div class="col-lg-6">
              <div class="service-body">
                <h4 class="service-title">Global Trade Solutions</h4>
                <p class="service-lead">
                  Export–import made simple: documentation, customs, ocean/air, and door-to-door multi-modal—on time and compliant.
                </p>
                <ul class="service-bullets">
                  <li><i class="bi bi-file-earmark-check"></i><span>CHA & customs clearance (import/export)</span></li>
                  <li><i class="bi bi-airplane"></i><span>Ocean & air with dependable transits</span></li>
                  <li><i class="bi bi-globe2"></i><span>Incoterms guidance & duty support</span></li>
                  <li><i class="bi bi-geo"></i><span>Worldwide coverage with tracking</span></li>
                </ul>
              </div>
            </div>
          </div>
...
<section class="py-5 bg-light" id="products">
  <div class="container">
    <h2 class="text-center mb-5 fw-bold section-title" style="color:var(--c-blue);">Our Products</h2>
    <div class="row g-4">

      <!-- Fly Ash -->
      <div class="col-md-6 col-lg-3">
        <div class="card h-100 shadow-sm border-0 rounded-14 text-center p-4">
          <div class="icon-badge mb-3">
            <i class="fas fa-mountain" style="color:var(--c-deepteal);"></i>
          </div>
          <h5 class="card-title fw-bold" style="color:var(--c-deepteal);">Fly Ash</h5>
      ...
      <div class="col-md-6 col-lg-3">
        <div class="card h-100 shadow-sm border-0 rounded-14 text-center p-4">
          <div class="icon-badge mb-3">
            <i class="fas fa-seedling" style="color:var(--c-deepteal);"></i>
          </div>
          <h5 class="card-title fw-bold" style="color:var(--c-deepteal);">Ultra Fine Fly Ash</h5>
          <p class="card-text text-muted">
      ...
      <div class="col-md-6 col-lg-3">
        <div class="card h-100 shadow-sm border-0 rounded-14 text-center p-4">
          <div class="icon-badge mb-3">
            <i class="fas fa-cubes" style="color:var(--c-deepteal);"></i>
          </div>
          <h5 class="card-title fw-bold" style="color:var(--c-deepteal);">Fly Ash Bricks</h5>
          <p class="card-text text-muted">
      ...
      <div class="col-md-6 col-lg-3">
        <div class="card h-100 shadow-sm border-0 rounded-14 text-center p-4">
          <div class="icon-badge mb-3">
            <i class="fas fa-circle-notch" style="color:var(--c-deepteal);"></i>
          </div>
          <h5 class="card-title fw-bold" style="color:var(--c-deepteal);">Cenosphere</h5>
          <p class="card-text text-muted">
          ...
          <button class="btn btn-teal mt-2" data-bs-toggle="modal" data-bs-target="#modalCenospheres">Read more</button>
        </div>
      </div>
...
<!-- Fly Ash — Modal -->
<div class="modal fade product-modal" id="modalFlyAsh" tabindex="-1" aria-labelledby="modalFlyAshLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modalFlyAshLabel">
          <span class="badge rounded-pill">Product</span> Fly Ash — Details
        </h5>
      ...
      <div class="modal-body">
        ...
        <div class="lead-block">
          <h6>What is Fly Ash</h6>
          <p class="mb-0">
            Fly Ash (pulverized fuel ash) is a byproduct of a coal-based thermal power station generated by the combustion
            of pulverized coal. It is a fine, grey amorphous powder, rich in silica &amp; alumina and spherical in shape.
            Its properties vary based on coal type, combustion process, and plant efficiency, all of which affect its
            utilization quality.
          </p>
        </div>
        ...
        <div class="columns">
          <div class="lead-block">
            <h6>Leveraging Technology to Elevate Quality</h6>
            <p class="mb-2">
              Loadplus provides Fly Ash that is highly reactive and has water-reducing characteristics. It is among the
              first classified and processed materials made available in India. By classifying and processing, Loadplus
              ensures an optimum proportion of fine particles, delivering consistent quality.
            </p>
            <p class="mb-0">
              Our Fly Ash meets stringent international standards: <strong>IS EN 450 S</strong>, <strong>ASTM C 618 Class F</strong>, and
              <strong>IS 3812 Part 1</strong> Grade I.
            </p>
          </div>

          <div class="lead-block">
            <h6>Concrete Application Advantages</h6>
            <ul class="bullet-list">
              <li><span class="bullet-dot"></span><span>Better Workability</span></li>
              <li><span class="bullet-dot"></span><span>Reduces Permeability</span></li>
              <li><span class="bullet-dot"></span><span>Reduces Heat of Hydration</span></li>
              <li><span class="bullet-dot"></span><span>Improves Pumpability</span></li>
              <li><span class="bullet-dot"></span><span>Improves Sulphate &amp; Chloride Resistance</span></li>
              <li><span class="bullet-dot"></span><span>Reduces Risk of Alkali Aggregate Reaction</span></li>
              <li><span class="bullet-dot"></span><span>Increases Long Term Strength</span></li>
              <li><span class="bullet-dot"></span><span>Better Concrete Finish</span></li>
              <li><span class="bullet-dot"></span><span>Reduces Bleeding &amp; Segregation</span></li>
              <li><span class="bullet-dot"></span><span>Reduces Shrinkage</span></li>
            </ul>
          </div>
        </div>
        ...
        <!-- APPLICATIONS -->
        <div class="lead-block">
          <h6>Applications of Fly Ash</h6>
          <ul class="bullet-list">
            <li><span class="bullet-dot"></span><span>Ready Mix Concrete</span></li>
            <li><span class="bullet-dot"></span><span>Asbestos Products Manufacturing</span></li>
            <li><span class="bullet-dot"></span><span>Cement Manufacturing</span></li>
            <li><span class="bullet-dot"></span><span>Bricks &amp; Blocks Manufacturing</span></li>
            <li><span class="bullet-dot"></span><span>Builders &amp; Contractors</span></li>
            <li><span class="bullet-dot"></span><span>Precast Manufacturing</span></li>
            <li><span class="bullet-dot"></span><span>Plaster &amp; Masonry Works</span></li>
            <li><span class="bullet-dot"></span><span>Land Fill &amp; many more</span></li>
          </ul>
        </div>
        ...
        <div class="spec-table">
          <table class="table mb-0">
            <thead>
              <tr>
                <th class="sticky-col">Characteristic</th>
                <th>BS EN 450 S</th>
            ...
            <tbody>
              <tr>
                <td class="sticky-col">SiO₂ + Al₂O₃ + Fe₂O₃ (%) Min</td>
                <td>70.00</td><td>70.00</td><td>70.00</td><td>95.89</td><td>92.83</td>
              </tr>
              <tr>
                <td class="sticky-col">SiO₂ (%) by mass Min</td>
                <td>–</td><td>–</td><td>35.00</td><td>62.57</td><td>60.80</td>
              </tr>
              <tr>
                <td class="sticky-col">MgO (%) Max</td>
                <td>4.0</td><td>5.00</td><td>5.00</td><td>0.85</td><td>0.98</td>
              </tr>
              <tr>
                <td class="sticky-col">SO₃ (%) Max</td>
                <td>2.50</td><td>5.0</td><td>2.75</td><td>0.080</td><td>0.25</td>
              </tr>
              <tr>
                <td class="sticky-col">Moisture (%) Max</td>
                <td>0.5</td><td>3.0</td><td>–</td><td>0.22</td><td>0.20</td>
              </tr>
              <tr>
                <td class="sticky-col">Loss on Ignition (%) Max</td>
                <td>7.0</td><td>6.0</td><td>6.0</td><td>&lt;1.00</td><td>&lt;1.50</td>
              </tr>
              <tr>
                <td class="sticky-col">Available Alkalis as Na₂O (%) Max</td>
                <td>–</td><td>1.50</td><td>1.50</td><td>0.96</td><td>0.98</td>
              </tr>
              <tr>
                <td class="sticky-col">Fineness (% retained on 45µ) Max</td>
                <td>12</td><td>34</td><td>34</td><td>&lt;10</td><td>&lt;30</td>
              </tr>
            </tbody>
          </table>
        </div>
...
<!-- Cenospheres — Modal -->
<div class="modal fade product-modal" id="modalCenospheres" tabindex="-1" aria-labelledby="modalCenospheresLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl modal-dialog-centered">
    <div class="modal-content">
      <!-- Header -->
      <div class="modal-header">
        <h5 class="modal-title d-flex align-items-center gap-2" id="modalCenospheresLabel">
          <span class="badge rounded-pill">Product</span>
          Cenospheres — Details
        </h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      ...
      <div class="modal-body">
        ...
        <div class="lead-block">
          <h6>About</h6>
          <p class="mb-0">
            We take pleasure in introducing ourselves as one of India’s leading <strong>CENOSPHERES</strong> and <strong>FLY ASH</strong> Processor,
            Distributor, Transporter and Exporter. Loadplus has earned an outstanding reputation and have been able to
            distinguish ourselves as a leading supplier by constantly defining and refining excellence in products, process and customer care.
            <strong>Cenosphere</strong> is a glass hard, inert, hollow silicate sphere. Cenosphere is primarily used to reduce the weight of plastics, rubbers,
            resins, cement, etc., but also imparts further benefits in many situations. Many of the advantages from the use of Cenosphere, including increased
            filler loading are directly attributed to the spherical nature of the material.
          </p>
        </div>
        ...
        <div class="lead-block">
          <h6>Cenospheres</h6>
          <p class="mb-0">
            Cenosphere is a glass hard, inert, hollow silicate sphere. Cenosphere is primarily used to reduce the weight of plastics, rubbers, resins, cement, etc.,
            but also imparts further benefits in many situations. Many of the advantages from the use of Cenosphere, including increased filler loading are directly
            attributed to the spherical nature of the material.
          </p>
        </div>

        <!-- Shipment & Storage / Why Ashtech -->
        <div class="columns">
          <div class="lead-block">
            <h6>Shipment &amp; Storage</h6>
            <ul class="bullet-list">
              <li><span class="bullet-dot"></span><span>Cenospheres is available in 50Kgs and 500 Kgs Bags with liner to prevent ingression of moisture.</span></li>
              <li><span class="bullet-dot"></span><span>In order of ease in handling, 2 × 500Kgs of cenospheres bags are stacked on a wooden pallet.</span></li>
              <li><span class="bullet-dot"></span><span>All palletized cargo are shrink &amp; strap wrapped.</span></li>
              <li><span class="bullet-dot"></span><span>All pallets can carry specific labeling as per customer requirements.</span></li>
            </ul>
          </div>
          ...
          <div class="lead-block">
            <h6>Why Loadplus?</h6>
            <ul class="bullet-list">
              <li><span class="bullet-dot"></span><span>Long-term contracts with power stations for raw Cenospheres sourcing.</span></li>
        ...
        <div class="columns">
          <div class="lead-block">
            <h6>Advantages</h6>
            <ul class="bullet-list">
              <li><span class="bullet-dot"></span><span>Light Weight</span></li>
              <li><span class="bullet-dot"></span><span>Spherical shape</span></li>
              <li><span class="bullet-dot"></span><span>Increased Filler Loadings</span></li>
              <li><span class="bullet-dot"></span><span>High melting point</span></li>
              <li><span class="bullet-dot"></span><span>Inert material</span></li>
              <li><span class="bullet-dot"></span><span>Reduced Water Absorption</span></li>
              <li><span class="bullet-dot"></span><span>Better Flow Characteristics</span></li>
              <li><span class="bullet-dot"></span><span>Less Shrinkage &amp; Warping</span></li>
              <li><span class="bullet-dot"></span><span>Improved Chemical Resistance</span></li>
              <li><span class="bullet-dot"></span><span>Low Carbon content</span></li>
            </ul>
          </div>
          ...
          <div class="lead-block">
            <h6>Applications</h6>
            <ul class="bullet-list">
              <li><span class="bullet-dot"></span><span>Oil Field Drilling</span></li>
              <li><span class="bullet-dot"></span><span>Special Paints</span></li>
              <li><span class="bullet-dot"></span><span>Refractory Works</span></li>
              <li><span class="bullet-dot"></span><span>Foundry Works</span></li>
              <li><span class="bullet-dot"></span><span>High Strength Rubber Manufacturing</span></li>
              <li><span class="bullet-dot"></span><span>Architectural Molding</span></li>
              <li><span class="bullet-dot"></span><span>Acrylic Casting &amp; Body Filler</span></li>
              <li><span class="bullet-dot"></span><span>Yacht Building</span></li>
              <li><span class="bullet-dot"></span><span>Marine Polyester</span></li>
              <li><span class="bullet-dot"></span><span>Epoxy Resin</span></li>
            </ul>
          </div>
        </div>
        ...
        <div class="spec-table">
          <table class="table mb-0">
            <thead>
              <tr>
                <th class="sticky-col">Chemical Properties — Description</th>
                <th>Unit</th>
                <th>Values</th>
              </tr>
            </thead>
            <tbody>
              <tr><td class="sticky-col">Al<sub>2</sub>O<sub>3</sub></td><td>%</td><td>28 to 35</td></tr>
              <tr><td class="sticky-col">SiO<sub>2</sub></td><td>%</td><td>55 to 58</td></tr>
              <tr><td class="sticky-col">Fe<sub>2</sub>O<sub>3</sub></td><td>%</td><td>2 to 2.40</td></tr>
              <tr><td class="sticky-col">CaO</td><td>%</td><td>0.6 to 1.0</td></tr>
              <tr><td class="sticky-col">MgO</td><td>%</td><td>&lt; 0.7</td></tr>
              <tr><td class="sticky-col">Na<sub>2</sub>O</td><td>%</td><td>&lt; 0.2</td></tr>
              <tr><td class="sticky-col">K<sub>2</sub>O</td><td>%</td><td>&lt; 2.0</td></tr>
              <tr><td class="sticky-col">C</td><td>%</td><td>0.88</td></tr>
              <tr><td class="sticky-col">TiO<sub>2</sub></td><td>%</td><td>1 to 2</td></tr>
            </tbody>
          </table>
        </div>
        ...
        <div class="spec-table">
          <table class="table mb-0">
            <thead>
              <tr>
                <th class="sticky-col">Physical Properties — Description</th>
                <th>Unit</th>
                <th>Values</th>
              </tr>
            </thead>
            <tbody>
              <tr><td class="sticky-col">Specific Gravity</td><td>Ton/M3</td><td>0.75 to 0.85</td></tr>
              <tr><td class="sticky-col">Bulk Density</td><td>Ton/M3</td><td>0.45 to 0.5</td></tr>
              <tr><td class="sticky-col">Moh’s</td><td>—</td><td>5 to 6</td></tr>
              <tr><td class="sticky-col">Shell Thickness of Sphere diameter</td><td>%</td><td>5 to 10</td></tr>
              <tr><td class="sticky-col">LOI</td><td>%</td><td>&lt; 1.0</td></tr>
              <tr><td class="sticky-col">Moisture</td><td>%</td><td>&lt; 0.5</td></tr>
              <tr><td class="sticky-col">Melting Point</td><td>°C</td><td>&gt; 1400</td></tr>
              <tr><td class="sticky-col">Sinkers</td><td>%</td><td>&lt; 5</td></tr>
              <tr><td class="sticky-col">Thermal Conductivity</td><td>—</td><td>Grey</td></tr>
              <tr><td class="sticky-col">Shape</td><td>—</td><td>Spherical</td></tr>
              <tr><td class="sticky-col">Dielectric Constant</td><td>—</td><td>2.0</td></tr>
            </tbody>
          </table>
        </div>
        ...
        <div class="spec-table">
          <table class="table mb-0">
            <thead>
              <tr>
                <th class="sticky-col">Grades — Particle Size Range (microns)</th>
                <th>Size (Micron)</th>
              </tr>
            </thead>
            <tbody>
